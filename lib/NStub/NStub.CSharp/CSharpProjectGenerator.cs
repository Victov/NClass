...
namespace NStub.CSharp
{
    ...
    public class CSharpProjectGenerator : IProjectGenerator
    {
        ...
        public CSharpProjectGenerator( string projectName, string outputDirectory )
        {
            ...
            if ( projectName == null )
                throw new ArgumentNullException( "projectName", Exceptions.ParameterCannotBeNull );
            ...
            if ( projectName.Length == 0 )
                throw new ArgumentException( Exceptions.StringCannotBeEmpty, "projectName" );
            ...
            ReferencedAssemblies.Add( new AssemblyName( "NUnit.Framework" ) );
        }
        ...
        public void GenerateProjectFile( )
        {
            ...
            _xmlWriter = XmlWriter.Create( OutputDirectory + Path.DirectorySeparatorChar + ProjectName + ".csproj", xmlWriterSettings );
        ...
        public IList< AssemblyName > ReferencedAssemblies { get; set; }
        ...
        private void AddClassFiles( )
        {
            ...
            {
                string scrubbedClassFile = Utility.ScrubPathOfIllegalCharacters( classFile );
        ...
        private void AddReferencedAssemblies( )
        {
            ...
            // to add a duplicate
            List< AssemblyName > assembliesAlreadyReferenced = new List< AssemblyName >( ReferencedAssemblies.Count );
            ...
            foreach ( AssemblyName referencedAssembly in ReferencedAssemblies )
                if ( !assembliesAlreadyReferenced.Contains( referencedAssembly ) )
                {
                    ...
                    _xmlWriter.WriteAttributeString( "Include", referencedAssembly.FullName );
        ...
        private void WritePropertyGroupElement( string configuration, string platform )
        {
            ...
            else if ( string.Equals( configuration, "Debug", StringComparison.InvariantCultureIgnoreCase ) && string.Equals( platform, "AnyCPU", StringComparison.InvariantCultureIgnoreCase ) )
            {
                WriteDebugConfiguration( );
            }
            else if ( string.Equals( configuration, "Release", StringComparison.InvariantCultureIgnoreCase ) && string.Equals( platform, "AnyCPU", StringComparison.InvariantCultureIgnoreCase ) )
            {
        ...
        private void WriteDefaultConfiguration( )
        {
            ...
            _xmlWriter.WriteAttributeString( "Condition", " '$(Configuration)' == '' " );
            ...
            _xmlWriter.WriteValue( ProjectName );
