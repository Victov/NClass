...
namespace NStub.CSharp
{
    ...
    public class CSharpProjectGenerator : IProjectGenerator
    {
        ...
        {
            get { return _classFiles; }
            set { _classFiles = value; }
        }
        ...
        public void GenerateProjectFile( )
        {
            ...
            _xmlWriter = XmlWriter.Create( _outputDirectory + Path.DirectorySeparatorChar + _projectName + ".csproj", xmlWriterSettings );
        ...
        private void AddReferencedAssemblies( )
        {
            ...
            // to add a duplicate
            List< AssemblyName > assembliesAlreadyReferenced = new List< AssemblyName >( _referencedAssemblies.Count );
