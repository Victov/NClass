...
namespace NClass.AssemblyCSharpImport.Controls
{
    public class DataGridViewImageComboBoxEditingControl : ImageComboBox, IDataGridViewEditingControl
    {
        ...
        ///     <see cref="T:System.Windows.Forms.DataGridViewCell" /> that is being edited; null if there is no associated
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether the value of the editing control differs from the value of the hosting
        ///     cell.
        /// </summary>
        /// <returns>
        ...
        ///     <see cref="P:System.Windows.Forms.DataGridView.EditingPanel" /> but not over the editing control.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///     Determines whether the specified key is a regular input key that the editing control should process or a special
        ///     key that the <see cref="T:System.Windows.Forms.DataGridView" /> should process.
        /// </summary>
        /// <returns>
        ///     <c>true</c> if the specified key is a regular input key that should be handled by the editing control; otherwise,
        ///     <c>false</c>.
        /// </returns>
