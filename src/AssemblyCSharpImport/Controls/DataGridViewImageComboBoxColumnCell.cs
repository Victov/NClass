...
namespace NClass.AssemblyCSharpImport.Controls
{
    public class DataGridViewImageComboBoxColumnCell : DataGridViewComboBoxCell
    {
        ...
        ///     A <see cref="T:System.ComponentModel.TypeConverter" /> associated with the value type
        ///     that provides custom conversion to the formatted value type, or null if no such custom conversion is needed.
        /// </param>
        /// <param name="formattedValueTypeConverter">
        ///     A <see cref="T:System.ComponentModel.TypeConverter" /> associated with the
        ///     formatted value type that provides custom conversion from the value type, or null if no such custom conversion is
        ///     needed.
        /// </param>
        /// <param name="context">
        ...
        ///     Formatting failed and either there is no handler for the
        ///     <see cref="E:System.Windows.Forms.DataGridView.DataError" /> event of the
        ///     <see cref="T:System.Windows.Forms.DataGridView" /> control or the handler set the
        ///     <see cref="P:System.Windows.Forms.DataGridViewDataErrorEventArgs.ThrowException" /> property to true. The exception
        ///     object can typically be cast to type <see cref="T:System.FormatException" /> for type conversion errors or to type
        ///     <see cref="T:System.ArgumentException" /> if <paramref name="value" /> cannot be found in the
        ...
        /// <param name="cellStyle">The <see cref="T:System.Windows.Forms.DataGridViewCellStyle" /> in effect for the cell.</param>
        /// <param name="formattedValueTypeConverter">
        ///     A <see cref="T:System.ComponentModel.TypeConverter" /> for the display value
        ///     type, or null to use the default converter.
        /// </param>
        /// <param name="valueTypeConverter">
