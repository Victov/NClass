...
namespace NClass.AssemblyCSharpImport
{
    ...
    public partial class ImportSettingsForm : Form
    {
        ...
        public ImportSettingsForm( ImportSettings settings )
        {
            ...
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Class, Resources.Class, FilterElements.Class ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Struct, Resources.Structure, FilterElements.Struct ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Interface, Resources.Interface32, FilterElements.Interface ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Delegate, Resources.Delegate, FilterElements.Delegate ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Enum, Resources.Enum, FilterElements.Enum ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_EnumValue, Resources.EnumItem, FilterElements.EnumValue ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Constructor, Resources.Constructor, FilterElements.Constructor ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Field, Resources.Field, FilterElements.Field ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Constant, Resources.PublicConst, FilterElements.Constant ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Property, Resources.Property, FilterElements.Property ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Method, Resources.Method, FilterElements.Method ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Operator, Resources.PublicOperator, FilterElements.Operator ) );
            colFilterElement.Items.Add( new ImageComboBoxItem( Strings.Element_Event, Resources.Event, FilterElements.Event ) );
            ...
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Static, Resources.Static, FilterModifiers.Static ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Default, Properties.Resources.ModifierDefault, FilterModifiers.Default ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Public, null, FilterModifiers.Public ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Private, Properties.Resources.ModifierPrivate, FilterModifiers.Private ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Internal, Properties.Resources.ModifierInternal, FilterModifiers.Internal ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_Protected, Properties.Resources.ModifierProtected, FilterModifiers.Protected ) );
            colFilterModifier.Items.Add( new ImageComboBoxItem( Strings.Modifier_ProtectedInternal, Properties.Resources.ModifierProtectedInternal, FilterModifiers.ProtectedInternal ) );
        ...
        /// </summary>
        private readonly Dictionary< FilterElements, ImageComboBoxItem > reverseElementNameMap = new Dictionary< FilterElements, ImageComboBoxItem >( );
        ...
        /// </summary>
        private readonly Dictionary< FilterModifiers, ImageComboBoxItem > reverseModifierNameMap = new Dictionary< FilterModifiers, ImageComboBoxItem >( );
